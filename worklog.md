...
- **2** messages non traités :
    ...
    - **MESSAGE (2):** Le message a été reçu sur la boîte email « operations@OldMailServer.com » et récupéré sur la boîte principale « operations@mycompany.com ».
        - Rédaction en cours d'un script de tests _(code added later, in 2017-09-16 commit)_ afin de vérifier si de tels messages auraient compromis un traitement pertinent des messages: _Récupération des IDs des « threads » auxquels appartiennent les messages envoyés [exclusivement] à l’adresse « operations@OldMailServer.com ». Vérifier les valeurs récupérées contre les journaux des messages traités._
